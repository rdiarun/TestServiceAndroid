...
namespace DetectorService
{
    ...
    public interface ITechnicianSync
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "SaveLocation", RequestFormat = WebMessageFormat.Json,
            ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ResultSet SaveLocation(Int32 technicianId , string lat , string lng);
    ...
    public class RootObject
    {
         ...
         [DataMember]
         public Int32 oldserviceSheetid { get; set; }
    }
